...
public class User_home_UI {
	...
	public static final String SEARCH_TEXTBOX = "xpath=//div/input[@name='s']";
	public static final String SEARCH_BUTTON = "xpath=//div/button[contains(@class,'wp-element-button')]";
